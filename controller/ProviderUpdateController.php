     ...
     function showForm($tableName) {
        ...
        if ($data->getLink() != NULL) {
            ...
            if ($data->getResultset() != NULL) {
                ...
                echo "\t\t\t<tr><td><label for=\"nameProvider\">Name Provider</label></td>"
                    . "<td><input id=\"nameProvider\" name=\"nameProvider\" type=\"text\" value=\"" 
                    . $provider->getNameProvider() . "\"></td></tr>\n";

                echo "\t\t\t<tr><td><label for=\"typeProvider\">Type Provider</label></td>"
                    . "<td><input id=\"typeProvider\" name=\"typeProvider\" type=\"text\" value=\"" 
                    . $provider->getTypeProvider() . "\"></td></tr>\n";
