...
<?php
    ...
    if(isset($_SESSION['username'])){
        echo "<h1>Add an Client</h1>";
        echo "<div><a class='button' href='../controller/ClientController.php'>View Clients</a></div>";
        echo "<br>";
    ...
    function showForm($tableName) {
        ...
        if ($data->getLink() != NULL) {
            $client = view2object();
            $data->setQuery(insertQuery($client, $tableName));
            $data->execute();
    ...
    function insertQuery($client) {
        return "INSERT INTO client (nameclient,lastnameclient,idclient) VALUES ('"
